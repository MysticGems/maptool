...
public class AutoResizeStampDialog extends JDialog
{
	...
	public AutoResizeStampDialog(int selectedWidth, int selectedHeight, int stampWidth, int stampHeight, int anchorX, int anchorY)
	{
		...
		chckbxAdjustVerticalAnchor.addActionListener(new ActionListener() {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e)
					{
						...
						cellHeightSelected = Integer.parseInt(spinnerCellHeightSelected.getValue().toString());
						pixelWidthSelected = Integer.parseInt(spinnerPixelWidthSelected.getValue().toString());
						pixelHeightSelected = Integer.parseInt(spinnerPixelHeightSelected.getValue().toString());
